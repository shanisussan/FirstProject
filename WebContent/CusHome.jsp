    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="temp_request_view.jsp">TP Request</a>
            <span class="badge"><%=count_tp_request%></span>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#about">PM Request</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="RTO_view.jsp">View</a>
          </li>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto text-center">
          <p class="large text-muted">he Motor Vehicles Department is regulated by the Government of Kerala
