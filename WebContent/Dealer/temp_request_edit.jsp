		...
		<div class="wrap-contact100">
			...
			<%
				...
				<div class="wrap-input100 validate-input bg0 rs1-alert-validate" data-validate = "Please Type Customer Address">
					...
					<textarea class="input100" value="<%=temp.getCus_address()%>"  name="txtCaddress" id="txtCaddress" placeholder="Customer Address here..."></textarea>
				</div>
				...
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate = "Enter purcahse date">
					...
					<input class="input100" type="date" value="<%=temp.getPuchase_date()%>" name="txtPurdate"  id="txtPurdate" placeholder="Enter purcahse date ">
				</div>
